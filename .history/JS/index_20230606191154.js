...
const validationsNode = document.getElementById('validations');
...
moviesNode.addEventListener('change', function(e){
    const movie = e.target.value;
    if(movies.indexOf(movie)){
        validationsNode.innerHTML = moviesNode;
        validationsNode.classList.remove('active');
    } else {
        validationsNode.classList.add('active');
    }
})
